...
import com.com.drawingcanvas.brushes.androidpathbrushes.PathBrush;
import com.com.drawingcanvas.brushes.stampbrushes.StampBrush;
...
public class BrushDrawPreview {
    ...
    BrushDrawPreview(Context context, Brushes brushes, int w, int h) {
        mBrushes = brushes;

...
public class BrushView extends View {
    ...
    private BrushDrawPreview mBrushDrawPreview;
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mBrushDrawPreview = new BrushDrawPreview(getContext(), mBrushes,mBackground.getWidth(), mBackground.getHeight());
        mBrushDrawPreview.setPreviewCallbacks(new BrushDrawPreview.PreviewCallbacks() {
            @Override
            public void onPreviewReadyToBeDrawn() {
                BrushView.super.invalidate();
            }
        });
        mBrushDrawPreview.preparePreview();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mBrushDrawPreview.drawPreview(canvas);
    }
    ...
    public void invalidate(){
        if (mBrushDrawPreview != null)
            mBrushDrawPreview.preparePreview();
    }

    public void setDrawingView(DrawingCanvas drawingCanvas) {
        mBrushes = drawingCanvas.getBrushes();
